...
Moreover,  since we propose for the first time the use of simulation as fitness function to guide the search for transplantation, \simhotep, it is natural to compare it with the established practice in the software transplantation field, which is constituted by the use of test suite to guide the transplantation. This motivates our second research question:
...
Similarly for RQ2 we test the following null hypothesis: 
...
The evaluation of \ApproachName{} and the SBPCG baseline was done using two PCs with the following specifications: Intel Core i7-8750H, 16GB; and  2x Intel(R) Xeon(R) CPU X5660, 64GB.
