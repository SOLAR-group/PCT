...
\begin{table}[tb]	
\caption{RQ1-RQ2. (a) Mean value and standard deviation for $Q_{Duration}$ obtained by each approach per boss and overall. (b) Wilcoxon test and Vargha-Delaney Â$_{12}$ results obtained by comparing \simhotep{} Vs. SBPCG (RQ1) and \simhotep{} Vs. \timhotep{} (RQ2) per boss and overall. Â$_{12}$: Large -- L.}
...
\begin{subtable}{.5\columnwidth}
	...
	\begin{tabular}{@{}lccc@{}}
		\toprule  & \simhotep{} & \timhotep{} & SBPCG     \\ \cmidrule(l){2-4} 
